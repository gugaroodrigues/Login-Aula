    ...
    return Scaffold(
      ...
      body: GradientBackground(
        ...
        child: SingleChildScrollView( // <--- Adicionado SingleChildScrollView aqui
          child: Column(
            children: [
              // Adicione um Padding superior para o conteúdo não ficar atrás da barra de status
              Padding(
                padding: EdgeInsets.only(top: MediaQuery.of(context).padding.top + 20),
                child: Column( // Envolva o conteúdo principal em um Column para o padding
                  children: [
                    // Card do Saldo
                    Container(
                    ...
                    const SizedBox(height: 60), // Espaço para os FABs
                  ],
                ),
              ),
            ],
